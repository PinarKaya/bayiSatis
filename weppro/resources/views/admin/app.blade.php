       ...
       <div class="inner-content">
        <!-- header-starts -->
               ...
               @yield('icerik')
                    ...
                    <div class="clearfix"> </div>
                        <p>© 2016 Tüm hakları saklıdır. |  <a href="http://bilimdeveri.com/">Bilimdeveri</a></p>
            </div>
        </div>
            </div>
            <!--content-->
                           ...
                           <div class="menu">
                                    <ul id="menu" >
                                        <li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Anasayfa</span></a></li>
                                         <li id="menu-academico" ><a href="/admin/admin_firmalar"><i class="fa fa-table"></i> <span> Firmalar</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                           <ul id="menu-academico-sub" >
                                           <li id="menu-academico-avaliacoes" ><a href="shoes.html">Firma Ekle</a></li>
                                            
                                          </ul>
                                        </li>
                                         <li id="menu-academico" ><a href="sunglasses.html"><i class="fa fa-file-text-o"></i> <span>Siparişer</span></a></li>
                                    <li><a href="sweater.html"><i class="lnr lnr-pencil"></i> <span>Müşteriler</span></a></li>
                                    <li id="menu-academico" ><a href="catalog.html"><i class="fa fa-file-text-o"></i> <span>Ürünler</span></a></li>
                                    <li id="menu-academico" ><a href="shoes.html"><i class="lnr lnr-book"></i> <span>Bakım</span></a></li>
                                     <li><a href="bags.html"><i class="lnr lnr-envelope"></i> <span>Stok</span></a></li>
